...
<section class="flex flex-col gap-16 text-slate-50/80 backdrop-blur-sm">
	<div class="flex flex-col gap-4 border-b border-slate-50/20 pb-4 lg:flex-row">
		<h2 class="text-xl font-thin">Select Version Update:</h2>
		<div class="relative max-w-96">
			<select
				bind:value={v}
				class="w-full cursor-pointer appearance-none overflow-ellipsis rounded-sm border border-secondary-dark/20 bg-secondary-acc/10 px-2 py-1 text-secondary-dark hover:bg-secondary-acc/20 lg:w-80"
			>
